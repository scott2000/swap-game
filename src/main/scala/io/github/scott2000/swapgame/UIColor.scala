...
object UIColor extends Reader[UIColor] {
  ...
  final object Red     extends UIColor(0xd82020, "Red",      0, NoRequirement)
  final object Orange  extends UIColor(0xff8800, "Orange",  10, ChainRequirement(   7, Some("CgkItbTPhNUKEAIQAQ")))
  ...
  final object Violet  extends UIColor(0x8000b8, "Violet",  50, ComboRequirement(  50, Some("CgkItbTPhNUKEAIQBQ")))
  final object Magenta extends UIColor(0xc800a0, "Magenta", 60, ScoreRequirement(2500, Some("CgkItbTPhNUKEAIQBg")))
}
